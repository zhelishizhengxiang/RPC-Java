package com.simon.client.rpcClient.impl;


import com.simon.client.netty.nettyInitializer.NettyClientInitializer;
 ...
 * @Description: netty后的客户端类。只负责发送消息，底层通信部分都交给代理类来做
 * @Author: Simon
