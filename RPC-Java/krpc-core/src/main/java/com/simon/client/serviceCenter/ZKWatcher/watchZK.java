package com.simon.client.serviceCenter.ZKWatcher;
    ...
    public void watchChange(String path) throws InterruptedException {
        ...
        curatorCache.listenable().addListener(new CuratorCacheListener() {
            ...
            public void event(Type type, ChildData childData, ChildData childData1) {
                ...
                switch (type.name()) {
                    case "NODE_CREATED": // 监听器第一次执行时节点存在也会触发此事件。监听器启动时，它会扫描Zookeeper中已有的所有服务节点，并将它们视为"新创建"的节点，触发NODE_CREATED事件
                        ...
                        if(pathList.length<=2)
                            ...
                            System.out.println("新增服务"+serviceName+" "+address);
                            break;
                        }
                    ...
                    case "NODE_DELETED": // 节点删除
                        ...
                        if(pathList_d.length<=2) break;
                            ...
                            System.out.println("删除服务"+serviceName+" "+address);
                        }
                        break;
                    default:
                        break;
